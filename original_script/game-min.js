...
(function (pa) {
  ...
  class Sa {
    ...
    A(a) {
      ...
      for (b = this.H.length; a < b; ) {
        ...
        for (e = this.H.length; d < e; )
          (f = this.H[d++]), 0 != (f.i & c.B) && 0 != (f.B & c.i) && c.wo(f);
        if (0 != c.ca) {
          d = 0;
          ...
          for (e = this.X; d < e.length; )
            (f = e[d]), ++d, 0 != (f.i & c.B) && 0 != (f.B & c.i) && c.xo(f);
          d = 0;
    ...
    uc() {
      let a = ra.Cc,
        b = this.ic;
      this.jc != a &&
        (null == b && (this.ic = b = new Sa()), (this.jc = a), Sa.zd(b, this));
      return b;
    }
    static zd(a, b) {
  ...
  class sa {
    ...
    ag(a, b, c) {
      if (b.fa != c) {
        ...
        this.K.push(b);
        if (null != this.M) {
          null != b.I && (O.remove(this.M.va.H, b.I), (b.I = null));
          this.M.Wk(b);
          let d = 0,
            e = !1;
          for (; !e; ) {
  ...
  class Qb {
    ...
    $h(a, b) {
      ...
      let c = this;
      this.ua.Ra.setRemoteDescription(
        new RTCSessionDescription({ sdp: a, type: "answer" })
      )
        .then(function () {
          let d = 0;
          for (; d < b.length; ) c.ua.Ra.addIceCandidate(b[d++]);
        })
        .catch(function () {
          c.ie(ha.Error);
        });
  ...
  class A {
    ...
    Lb(a) {
      ...
      this.a += a.byteLength;
      this.tc(this.a);
      new Uint8Array(this.s.buffer, this.s.byteOffset, this.s.byteLength).set(
        a,
        b
      );
    }
            ...
            ? (this.s.setUint8(b + 2, (a >> 14) | 128),
              2097152 <= a
                ? (this.s.setUint8(b + 3, (a >> 21) | 128),
                  268435456 <= a
                    ? (this.s.setUint8(b + 4, (a >> 28) & 127), (a = 5))
                    : (this.s.setUint8(b + 3, this.s.getUint8(b + 3) & 127),
                      (a = 4)))
  ...
  class nb {
    ...
    $i(a) {
      ...
      null == a && (a = "");
      let d = this;
      Z.Yl(this.js, "token=" + this.Ff + "&rcr=" + a, Z.Lj)
        .then(function (e) {
          switch (e.action) {
            case "connect":
              c(e);
    ...
    xp(a, b, c, d, e, f) {
      if (16 <= this.xd.size) this.Hf(a, 4104);
        ...
        if (
          null != this.qk &&
          ((h = new J(e.s)), (h.a = e.a), (e = this.qk(b, h)), 1 == e.pb)
        ) {
          this.Hf(a, e.reason);
          return;
        }
    ...
    A() {
      ...
      if (this.Lp != a || this.Kp != b)
        (this.Lp = a),
          ...
          (this.Bp.className =
            "icon-" +
            (0 >= a ? "volume-off" : 0.5 >= a ? "volume-down" : "volume-up")),
  ...
  class Tb {
    ...
    Fa(a) {
      var b = a.code;
      b = m.j.Jd.v().v(b);
      null != b && (a.preventDefault(), this.tq(b));
    }
    ld(a) {
      a = m.j.Jd.v().v(a.code);
      null != a && this.jq(a);
    ...
    tq(a) {
      this.Qc.has(a) || (this.Qc.add(a), this.A(), D.h(this.xl, a));
    }
    jq(a) {
  ...
  class C {
        ...
        C.Ss(function () {
          ...
          let b =
            ...
            c = Z.v("res.dat", "arraybuffer").then(function (d) {
              ...
              return Promise.all([
                m.Qa.Xo,
                C.ih(d.file("images/grass.png").asArrayBuffer()).then(function (
                  e
                ) {
                  return (m.qp = e);
                }),
                C.ih(d.file("images/concrete.png").asArrayBuffer()).then(
                  function (e) {
                    return (m.Co = e);
                  }
                ),
                C.ih(d.file("images/concrete2.png").asArrayBuffer()).then(
                  function (e) {
                    return (m.Ao = e);
                  }
                ),
                C.ih(d.file("images/typing.png").asArrayBuffer()).then(
                  function (e) {
                    return (m.cn = e);
                  }
                ),
    ...
    static Na(a) {
      ...
      null != a && (C.$g.appendChild(a), (C.wn = a));
    }
  }
  class q {
    constructor() {
    ...
    ga(a) {
      ...
      if (!this.cf()) {
        ...
        a.m(this.Md.length);
        b = 0;
        for (c = this.Md; b < c.length; ) (d = c[b]), ++b, a.u(d.x), a.u(d.y);
        a.m(this.vd.length);
        b = 0;
    ...
    ws(a) {
      ...
      this.X = [];
      c = a.F();
      for (d = 0; d < c; ) ++d, (e = new I()), e.ma(a, this.L), this.X.push(e);
      this.sa = [];
      c = a.F();
      for (d = 0; d < c; ) ++d, (e = new Q()), e.ma(a), this.sa.push(e);
      this.vc = [];
      c = a.F();
      for (d = 0; d < c; ) ++d, (e = new pb()), e.ma(a), this.vc.push(e);
      this.H = [];
      c = a.F();
      for (d = 0; d < c; ) ++d, (e = new xa()), e.ma(a), this.H.push(e);
      this.qb = [];
      c = a.F();
      for (d = 0; d < c; ) ++d, (e = new rb()), e.ma(a), this.qb.push(e);
      this.Md = b();
      this.vd = b();
      this.qe();
      if (!this.gn()) throw v.C(new Ta("Invalid stadium"));
    }
    gn() {
      return 0 >= this.H.length || 0 > this.Gc || 0 > this.bd || 0 > this.Kd.V
        ? !1
        : !0;
    }
    qe() {
    ...
    sg(a, b, c, d, e, f) {
      ...
      for (b = this.L.length; h < b; )
        (k = h++), (this.L[k].i = f), (this.L[k].B = g), (this.L[k].o = 0.1);
      b = this.X.length;
      this.X.push(l);
      this.X.push(t);
      this.X.push(z);
      ...
      for (b = this.X.length; h < b; )
        (k = h++), (this.X[k].i = f), (this.X[k].B = g), (this.X[k].o = 0.1);
      f = new xa();
      g = f.a;
      g.x = a;
      g.y = -c;
  ...
  class Xb {
    ...
    oo(a, b) {
      ...
      if (null != b) {
        ...
        for (d = this.Zj; c < d.length; )
          (e = d[c]), ++c, (f = a(e)), 0 <= f && b.push({ Hn: f, item: e });
        b.sort(function (l, n) {
          return l.Hn - n.Hn;
        });
        this.kj(b);
    ...
    Gk(a) {
      ...
      this.Aq(
        O.substr(this.lm, 0, this.Ii) +
          a +
          " " +
          O.substr(this.lm, this.Ii + this.Er, null),
        this.Ii + a.length + 1
      );
    }
    kj(a) {
    ...
    Wo() {
      null != this.dd && (this.Gk(this.dd[this.zc].item), this.bi());
    }
    static ap(a) {
  ...
  class na {
    constructor(a) {
      function b(y) {
        ...
        L.onclick = function () {
          ...
          qc.onkeydown = function (T) {
            ...
            T.stopPropagation();
            T = T.code;
            null == tb.v(T) && (tb.Pa(T, y), m.j.Jd.ha(tb), Gc());
          };
        };
        return F;
      }
      ...
      function h(y) {
        let F = { kn: l.get(y + "btn"), ph: l.get(y + "sec") };
        n.push(F);
  ...
  class Zb {
    static Kr(a, b) {
      Zb.vm(new Blob([a], { type: "octet/stream" }), b);
    }
    static Lr(a, b) {
      Zb.vm(new Blob([a], { type: "text/plain" }), b);
    }
    static vm(a, b) {
  ...
  class Ba {
    constructor(a, b, c) {
      ...
      this.ig = [];
      this.cd = [];
      this.Ra = new RTCPeerConnection({ iceServers: b }, Ba.Fo);
      let d;
    ...
    Qj(a) {
      ...
      window.setTimeout(function () {
        "closed" != b.Ra.iceConnectionState &&
          b.Ra.addIceCandidate(a).catch(function () {});
      }, this.wk);
    }
    zp() {
      this.Yh();
    ...
    static ep() {
      try {
        return window.crypto.subtle
          .generateKey(U.yh, !0, ["sign", "verify"])
          .then(function (a) {
            let b = a.privateKey;
  ...
  class Oa {
    ...
    A() {
      ...
      !this.lg || 0 < this.Ji.Pd || ((this.lg = !1), this.Dq());
    }
    static pl(a) {
      a = (a / 1e3) | 0;
  ...
  class rc {
    ...
    Rc() {
      ...
      (1 == m.j.Rh.v() && 28.333333333333336 > a - this.hd) ||
        ((this.hd = a),
        this.Bd++,
        this.Jm(m.j.Rd.v()),
      ...
      if (null != b)
        if (2 == b.Cb) 0 >= b.Ta && this.Fj(1);
          ...
          null != n &&
            null != g &&
            0 >= b.Ta &&
            (h.a.x > n.a.x && e.a.x > n.a.x && 20 < e.a.x && this.Fj(0.3),
            r.a.x < g.a.x && e.a.x < g.a.x && -20 > e.a.x && this.Fj(0.3));
        }
    }
  }
  class za {
  ...
  class Pa {
    constructor(a) {
      ...
      this.f.ondrop = function (d) {
        ...
        null != d && ((d = R.parseInt(d)), null != d && wa.h(c.Ag, d, a));
      };
      ...
      this.$a.onkeydown = function (c) {
        switch (c.keyCode) {
          ...
          case 13:
            ...
            break;
          case 27:
            b.Fc.Qb.hidden ? ((b.$a.value = ""), b.$a.blur()) : b.Fc.bi();
            break;
          case 38:
            b.Fc.hk(-1);
            break;
  ...
  class V {
    ...
    Rc(a, b) {
      ...
      if (null != a.M) {
        ...
        var e = c.va,
          ...
          h =
            0 != this.Ld
              ? this.na.height / this.Ld
              : this.Ig * window.devicePixelRatio * this.te;
        b = this.Wg * this.te;
        ...
        for (var r = 0, t = a.K; r < t.length; ) {
          ...
          null == K && ((K = new Db()), this.nd.set(z.Z, K));
          K.A(z, a);
          this.Ug.set(z.I, K);
        }
        ...
        for (g = a.K; f < g.length; )
          (l = g[f]),
            ++f,
            (n = l.I),
            null != n && ((l = this.nd.get(l.Z)), this.km(n, l));
        f = 0;
        for (e = e.H; f < e.length; )
          if (((g = e[f]), ++f, null == this.Ug.get(g))) {
            if (0 > g.V) break;
            this.km(g, null);
          }
        this.c.lineWidth = 3;
    ...
    wr(a, b) {
      ...
      for (a = a.K; d < a.length; ) {
        ...
        c && g.mg && this.c.drawImage(m.cn, e.x - 0.5 * m.cn.width, e.y - 35);
    ...
    km(a, b) {
      0 > a.V ||
        (this.c.beginPath(),
        null == b
          ? ((this.c.fillStyle = V.nc(a.S)), (this.c.strokeStyle = "black"))
          : ((this.c.fillStyle = b.$j), (this.c.strokeStyle = b.Ro)),
        this.c.beginPath(),
      ...
      switch (b) {
        ...
        case "clear_bans":
          null == this.ce
            ...
            : (this.ce(), this.da("All bans have been cleared"));
          break;
        case "clear_password":
          null == this.Rg
  ...
  class B {
    ...
    static To(a, b) {
      ...
      let e = null;
      e = function (f, g) {
        Z.Yl(m.Se + "api/client", "room=" + f + "&rcr=" + g, Z.Lj)
          .then(function (h) {
            switch (h.action) {
              case "connect":
                h = h.token;
  ...
  class Rb {
    ...
    la() {
      ...
      this.Ed &&
        ((this.Ed = !1), this.Ra.close(), null != this.tf && this.tf());
    }
  }
  class H {
    static h(a) {
  ...
  class jc {
    ...
    ct() {
      ...
      return { Dj: this.r.pc.index, $s: this.r.pc[0].length };
    }
    bt(a, b) {
      var c;
      null == c && (c = -1);
      if (this.r.global) {
        ...
        if ((b = null != this.r.pc)) this.r.ph = a;
        return b;
      }
      if ((c = this.match(0 > c ? O.substr(a, b, null) : O.substr(a, b, c))))
        (this.r.ph = a), (this.r.pc.index += b);
      return c;
    }
  }
  class Kc {
  ...
  class Ab {
    ...
    A(a, b) {
      this.Dr != a.lc && ((this.Dr = a.lc), (this.lc.textContent = a.lc));
      b = null == b ? !1 : b.fb;
      this.Ak != b &&
    ...
    Uj(a) {
      this.Kl = a;
      this.wi.innerHTML =
        "<i class='icon-pause'></i>" + (this.Kl ? "Resume (P)" : "Pause (P)");
    }
  }
  class ua {
    constructor() {
    ...
    Ws() {
      let a = ra.Cc,
        b = this.Cn;
      this.Cc != a &&
        (null == b && (this.Cn = b = new ua()), (this.Cc = a), ua.Ns(b, this));
      return b;
    }
    static Ns(a, b) {
      a.fb = b.fb;
  ...
  class Qa {
    constructor(a) {
      ...
      0 != c &&
        (a.Fm(m.j.Ad.v()), this.l.Ka.Hb("Extrapolation set to " + c + " msec"));
    }
    ls() {
    ...
    Am(a) {
      a != this.bl && (this.za.ta(Ca.qa(a ? 0 : 1)), (this.bl = a));
    }
    an() {
      if (null != this.za.U.M) {
        let a = new Ya();
  ...
  class fc {
    ...
    add(a) {
      ...
      b >= this.et
        ? ((b = this.cb[c]), (this.Yd -= b.weight), this.cb.splice(c, 1))
        : (b = new zc());
      b.value = a;
      b.weight = 1;
      b.index = 0;
  ...
  class Ib {
    static ni(a) {
      return new PerfectScrollbar(a, { handlers: Ib.Ap });
    }
  }
  class yb {
    constructor() {
  ...
  class Y {
    ...
    Wk(a) {
      if (a.fa == u.Oa) a.I = null;
        ...
        a.W = 0;
        var b = a.I;
        null == b && ((b = new qa()), (a.I = b), this.va.H.push(b));
        var c = this.T.Kd;
        b.S = 0;
        b.V = c.V;
        b.ca = c.ca;
        ...
        0 == d.length
          ? ((b.a.x = a.fa.Oh * this.T.bc), (b.a.y = 0))
    ...
    A(a) {
      if (0 < this.Ta) 120 > this.Ta && this.Ta--;
        ...
        if (0 == this.Cb) {
          for (a = 0; a < b.length; )
            (c = b[a]), ++a, null != c.I && (c.I.i = 39 | this.ke.Jp);
          b = this.va.H[0].G;
          ...
          for (
            a = 0;
            a < c &&
            ((d = a++), (d = this.T.ro(b[Y.yk[d]].a, Y.ul[d])), d == u.Oa);
          ...
          d != u.Oa
            ? ((this.Cb = 2),
              ...
              null != this.Sa.nm && this.Sa.nm(d.ba))
            : 0 < this.Ga &&
              this.Nc >= 60 * this.Ga &&
              this.Tb != this.Ob &&
              (null != this.Sa.fj && this.Sa.fj(), this.Sm());
        } else if (2 == this.Cb)
          this.yc--,
            0 >= this.yc &&
              ((0 < this.kb && (this.Tb >= this.kb || this.Ob >= this.kb)) ||
              (0 < this.Ga && this.Nc >= 60 * this.Ga && this.Tb != this.Ob)
                ? this.Sm()
                : (this.$k(), null != this.Sa.Uq && this.Sa.Uq()));
        else if (
          3 == this.Cb &&
          (this.yc--, 0 >= this.yc && ((b = this.Sa), null != b.M))
        ) {
          b.M = null;
          a = 0;
    ...
    $k() {
      ...
      this.Cb = 0;
      for (
        var b = this.T.H, c = this.va.H, d = 0, e = this.T.Df ? b.length : 1;
        d < e;
      ...
      return null == window.indexedDB
        ...
        : new Promise(function (b, c) {
            ...
            d.onsuccess = function () {
              ...
              try {
                Ob.rh(f.objectStore("files").add(a.Ce()))
                  .then(function (g) {
                    g = { name: a.D, id: g };
  ...
  class qa {
    ...
    uc() {
      let a = ra.Cc,
        b = this.ic;
      this.jc != a &&
        (null == b && (this.ic = b = new qa()), (this.jc = a), qa.zd(b, this));
      return b;
    }
    static zd(a, b) {
      a.V = b.V;
  ...
  class ac {
    ...
    Hi(a) {
      ...
      a.Tl = function (d, e, f, g) {
        ...
        null == e
          ? (d = "" + d.D + " has left")
          : (Nb.h(c.wq, d.Z, e, null != g ? g.D : null, f),
            (d =
              "" +
              d.D +
              " was " +
      ...
      a.Rl = function (d) {
        ...
        9e3 > e - d.un ||
          ((d.un = e),
          c.l.Ka.Hb(
            "" + d.D + " " + (d.Td ? "has desynchronized" : "is back in sync")
          ));
      };
      a.Wl = function (d, e, f) {
            ...
            try {
              ...
              (g = v.Mb(h).Fb()),
                g instanceof SyntaxError
                  ? D.h(b.vi, "SyntaxError in line: " + R.Je(g.lineNumber))
                  : g instanceof Ta
                  ? D.h(b.vi, g.eq)
                  : D.h(b.vi, "Error loading stadium file.");
            }
          };
          f.readAsText(e);
        }
  ...
  class oa extends W {
    ...
    Pg(a) {
      a.ob == this.Y && a.Dc <= this.ec
        ? ((a.Dc = this.ec++), a.apply(this.U), null != this.hc && this.hc(a))
        : this.ve.rn(a);
    }
    Qk(a, b) {
  ...
  class Ra extends oa {
    ...
    la(a) {
      null != this.rc && ((this.rc.kd = null), this.rc.no(), (this.rc = null));
      window.clearTimeout(this.Be);
      null != this.ua && ((this.ua.tf = null), this.ua.la(), (this.ua = null));
      this.zk = null == a ? "Connection closed" : a;
      this.If(4);
    }
    If(a) {
      this.yd != a && ((this.yd = a), null != this.Id && this.Id(a));
    }
    Ed() {
      return 3 == this.yd;
    }
  ...
  class cc extends oa {
    ...
    A() {
      ...
      this.Y - this.cl >= this.to && (this.Si(), this.Qr());
    }
    hg() {
      0 > this.dc && (this.dc = 0);
      return this.Qk(
        (window.performance.now() - this.bj) * this.Ec -
          this.Y +
          this.Od +
          this.dc +
          this.Ad
    ...
    hr(a, b) {
      ...
      if (null != e) {
        var f = b.Pj.get(e);
        null == f && ((f = new Eb(e.bh, e.sh)), b.Pj.set(e, f));
        if (!f.bn()) throw v.C(3);
      }
      e = this.Y + this.Od;
      f = this.Y;
      ...
      a.P = b.ba;
      a.ob = f;
      a.Bn(this.U) && (this.Pg(a), this.Qg(this.oi(a), 1));
    }
  }
  class dc extends oa {
    constructor(a, b, c) {
    ...
    kr(a) {
      ...
      for (; d < b; ) {
        ...
        c += a.Bb();
        let e = a.F();
        this.ol.push({ Dj: c / this.Bf, kind: e });
      }
    }
    cm() {
      var a = this.Sc;
    ...
    A() {
      ...
      0 < this.Pd
        ? ((this.Ub += 1e4),
          this.Ub > this.Pd && ((this.Ub = this.Pd), (this.Pd = -1)))
        : (this.Ub += b * this.Ol);
      a = this.Bf * this.vh;
      this.Ub > a && (this.Ub = a);
      b = this.Ub * this.Ec;
  ...
  class Ia extends p {
    ...
    apply(a) {
      let b = a.oa(this.P);
      null != b && this.kh != b.Td && ((b.Td = this.kh), D.h(a.Rl, b));
    }
    wa(a) {
      a.m(this.kh ? 1 : 0);
    }
  ...
  class Fa extends p {
    ...
    apply(a) {
      if (a.Pb(this.P)) {
        var b = a.oa(this.P);
        null == a.M && ((a.T = this.Xd), null != a.Zi && a.Zi(b, this.Xd));
      }
    }
    wa(a) {
      var b = A.ka();
  ...
  var ha = (Fb["bas.basnet.FailReason"] = {
    Wf: !0,
    $d: null,
    Zd: { wc: "PeerFailed", pb: 0, Gb: "bas.basnet.FailReason", toString: ka },
    Ne:
      ((X = function (a) {
        return { pb: 1, code: a, Gb: "bas.basnet.FailReason", toString: ka };
      }),
      (X.wc = "Rejected"),
      (X.Oe = ["code"]),
      X),
  ...
  uc.b = !0;
  Object.assign(uc.prototype, { g: uc });
  lc.b = !0;
  ec.b = !0;
  ...
  Cc.b = !0;
  bc.b = !0;
  Object.assign(bc.prototype, { g: bc });
  Ma.b = !0;
  Qa.b = !0;
  Object.assign(Qa.prototype, { g: Qa });
  ac.b = !0;
  Object.assign(ac.prototype, { g: ac });
  Tb.b = !0;
  ...
  C.b = !0;
  rc.b = !0;
  Object.assign(rc.prototype, { g: rc });
  Sb.b = !0;
  ...
  Object.assign(xb.prototype, { g: xb });
  wb.b = !0;
  Object.assign(wb.prototype, { g: wb });
  db.b = !0;
  Object.assign(db.prototype, { g: db });
  yb.b = !0;
  Object.assign(yb.prototype, { g: yb });
  ...
  Object.assign(Cb.prototype, { g: Cb });
  vc.b = !0;
  Object.assign(vc.prototype, { g: vc });
  ob.b = !0;
  ...
  u.Da.Dg = u.ia;
  w.Vn = {}.toString;
  Ba.Fo = { mandatory: { OfferToReceiveAudio: !1, OfferToReceiveVideo: !1 } };
  U.yh = { name: "ECDSA", namedCurve: "P-256" };
  U.Lm = { name: "ECDSA", hash: { name: "SHA-256" } };
  Ib.Ap = ["click-rail", "drag-thumb", "wheel", "touch"];
  p.yb = !1;
  p.qn = new Map();
  p.Nf = 0;
  W.yb = !1;
  Ua.Aa = p.Ha({ Ca: !1, delay: !1 });
  ra.Cc = 0;
  lc.channels = [
  ...
  q.qs = A.ka(1024);
  Ia.Aa = p.Ha({ Ca: !1, delay: !1, nh: { bh: 2, sh: 1e4 } });
  jb.Aa = p.Ha({ Ca: !1, delay: !1, nh: { bh: 10, sh: 900 } });
  Za.Aa = p.Ha({ Ca: !1, delay: !1 });
  va.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ha.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ka.Aa = p.Ha({ Ca: !1, delay: !1 });
  fa.Aa = p.Ha({ Ca: !1, delay: !1 });
  Fa.Aa = p.Ha({ Ca: !1, delay: !1, nh: { bh: 10, sh: 2e3 } });
  $a.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ga.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ea.Aa = p.Ha({ Ca: !1, delay: !1 });
  lb.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ya.Aa = p.Ha({});
  Va.Aa = p.Ha({ Ca: !1, delay: !1, nh: { bh: 10, sh: 900 } });
  Da.Aa = p.Ha({});
  Ca.Aa = p.Ha({ Ca: !1, delay: !1 });
  ma.Aa = p.Ha({ Ca: !1, delay: !1 });
  kb.Aa = p.Ha({ Ca: !1, delay: !1 });
  mb.Aa = p.Ha({ Ca: !1, delay: !1 });
  La.Aa = p.Ha({ Ca: !1, delay: !1 });
  Wa.Aa = p.Ha({ Ca: !1, delay: !1 });
  Xa.Aa = p.Ha({ Ca: !1, delay: !1 });
  Ja.Aa = p.Ha({ Ca: !1, delay: !1 });
  I.On = 0.17435839227423353;
  I.Nn = 5.934119456780721;
  ea.Ln = new $b([0, 0, 2, 1, 0, 0.35, 1, 0, 1, 0, 0.7, 1, 0, 0, 0, 1]);
  ea.Mn = new $b([0, -1, 3, 0, 0, 0.35, 0, 0, 0, 0, 0.65, 0, 0, 1, 3, 1]);
  Hb.O =
