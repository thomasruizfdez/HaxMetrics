(function (ub) {
  ...
  function Q(a, b, c) {
    ...
    for (
      var f = e.get("title"), e = e.get("buttons"), h = 0, m = 0;
      m < c.length;
  ...
  function R(a) {
    function b(a) {
      ...
      c.onclick = function () {
        ...
        n.onkeydown = function (b) {
          ...
          b.stopPropagation();
          b = b.code;
          null == p.la(b) && (p.xa(b, a), q.P.ze.tb(p), t());
        };
      };
      return b;
    }
    ...
    function f(a) {
      var b = { ih: l.get(a + "btn"), al: l.get(a + "sec") };
      u.push(b);
    ...
    d(
      ...
      function (a) {
        for (var b = 0, c = g.length - 1; b < c && !(g[b] <= a); ) ++b;
        return b;
      }
    );
  ...
  function X(a) {
    ...
    this.h.ondrop = function (c) {
      ...
      null != c && ((c = K.parseInt(c)), null != c && ea.u(b.se, c, a));
    };
  ...
  function cb() {
    ...
    for (var a = [], b = 0, c = this.gh; b < c; ) ++b, a.push(0);
  ...
  function oa() {
    ...
    this.uf.onclick = function () {
      if (null != a.Ea) {
        var b = a.Ea.nh;
        null != b && (a.Ea.Kb.remove(), (a.Ea = null), b(), a.Nd());
      }
    };
    this.Cf.onclick = function () {
      null != a.Ea &&
        a.Ea.ld().then(function (a) {
          Va.fk(a.jd(), a.C + ".hbs");
        });
    };
    this.Bj(c);
          ...
          try {
            ...
            (b = m instanceof r ? m.df : m),
              b instanceof SyntaxError
                ? A.u(a.te, "SyntaxError in line: " + K.Lc(b.lineNumber))
                : b instanceof Wa
                ? A.u(a.te, b.fj)
                : A.u(a.te, "Error loading stadium file.");
          }
        };
        c.readAsText(b);
      }
  ...
  function Y() {
    ...
    this.Ia.onkeydown = function (c) {
      switch (c.keyCode) {
        case 9:
          b.wb.Xa.hidden || (b.wb.ti(), c.preventDefault());
          break;
        case 13:
          a();
          break;
        case 27:
          b.wb.Xa.hidden ? ((b.Ia.value = ""), b.Ia.blur()) : b.wb.ge();
          break;
        case 38:
          b.wb.pf(-1);
          break;
  ...
  function J(a, b) {
    for (var c = [], d = 0; d < a.length; ) c.push(this.ej(a[d++], b));
    this.Vc = c;
  }
  function E() {
    ...
    this.ha = window.document.createElement("canvas");
    this.ha.mozOpaque = !0;
    this.b = this.ha.getContext("2d", { alpha: !1 });
  ...
  function ab(a, b, c) {
    ...
    if (1212305970 != a.Cc()) throw new r("");
    b = a.Cc();
    if (c != b) throw new r(new mb());
    this.ad = a.Cc();
  ...
  O.prototype = {
    Jd: function (a) {
      ...
      if (this.a + a > this.A.byteLength) throw new r("Read too much");
  ...
  H.nf = function (a) {
    for (var b = 0, c = a.length, d = 0; d < c; ) b += H.Th(F.lh(a, d++));
    return b;
  };
  H.Uh = function (a) {
    a >>>= 0;
  ...
  H.prototype = {
    ...
    Pb: function (a) {
      this.A.byteLength < a &&
        this.bk(2 * this.A.byteLength >= a ? 2 * this.A.byteLength : a);
    },
    bk: function (a) {
    ...
    Gc: function (a) {
      null == a ? this.Te(0) : (this.Te(H.nf(a) + 1), this.Hk(a));
    },
    Hk: function (a) {
      var b = this.a;
      this.Pb(b + H.nf(a));
      for (var c = a.length, d = 0; d < c; ) b += H.wi(F.lh(a, d++), this.A, b);
      this.a = b;
    },
    Te: function (a) {
      var b = this.a;
      ...
      128 <= a
        ? (this.A.setUint8(b + 1, (a >> 7) | 128),
          16384 <= a
            ? (this.A.setUint8(b + 2, (a >> 14) | 128),
              2097152 <= a
                ? (this.A.setUint8(b + 3, (a >> 21) | 128),
                  268435456 <= a
                    ? (this.A.setUint8(b + 4, (a >> 28) & 127), (a = 5))
                    : (this.A.setUint8(b + 3, this.A.getUint8(b + 3) & 127),
                      (a = 4)))
                : (this.A.setUint8(b + 2, this.A.getUint8(b + 2) & 127),
                  (a = 3)))
            : (this.A.setUint8(b + 1, this.A.getUint8(b + 1) & 127), (a = 2)))
        : (this.A.setUint8(b, this.A.getUint8(b) & 127), (a = 1));
      this.a += a;
    },
    f: H,
  };
  pa.c = !0;
  pa.Xf = function (a) {
    return new PerfectScrollbar(a, { handlers: pa.Li });
  };
  Va.c = !0;
  Va.fk = function (a, b) {
    Va.ek(new Blob([a], { type: "text/plain" }), b);
  };
  Va.ek = function (a, b) {
  ...
  Xa.prototype = {
    set: function (a) {
      this.value != a &&
        ((this.value = a), (this.Kb.textContent = "" + this.value));
    },
    f: Xa,
  };
  v.c = !0;
  ...
  k.pa = function (a) {
    a.hl = k.Ue;
    if (null == a.na) throw new r("Class doesn't have a config");
    k.qh.set(k.Ue, a);
    k.Ue++;
  };
  k.fl = function (a) {
  ...
  ab.prototype = y(ha.prototype, {
    Gj: function (a) {
      for (var b = a.$c(), c = 0, d = 0; d < b; ) {
        ...
        var c = c + a.Wb(),
          e = a.G();
        this.eg.push({ Zk: c / this.ad, kind: e });
      }
    },
    yg: function () {
      var a = this.Eb;
      0 < a.A.byteLength - a.a
        ? ((a = this.Eb.Wb()),
          (this.Cd += a),
          (a = this.Eb.$c()),
    ...
    X: function () {
      ...
      0 < this.jc
        ? ((this.ab += 1e4),
          this.ab > this.jc && ((this.ab = this.jc), (this.jc = -1)))
        : (this.ab += b * this.ng);
      a = this.ad * this.Vd;
      this.ab > a && (this.ab = a);
      b = this.ab * this.Fh;
  ...
  $a.prototype = {
    eval: function (a) {
      ...
      if (a <= this.fb[0]) return this.fb[1];
      if (a >= this.fb[b]) return this.fb[b - 2];
      for (var c = 0, b = (b / 5) | 0; ; ) {
        var d = (b + c) >>> 1;
  ...
  ib.prototype = {
    ...
    Eg: function (a) {
      ...
      a.sg = function (d, e, f, h) {
        ...
        null == e
          ? (d = "" + d.C + " has left")
          : (Sa.u(c.pl, d.aa, e, null != h ? h.C : null, f),
            (d =
              "" +
              d.C +
              " was " +
      ...
      a.pg = function (a) {
        c.T.Ga.hb(
          "" + a.C + " " + (a.nc ? "has desynchronized" : "is back in sync")
        );
      };
      a.vg = function (d, e, f) {
  ...
  N.prototype = {
    jd: function () {
      return JSON.stringify({ lat: this.Pf, lon: this.Wf, code: this.rd });
    },
    f: N,
  };
  kb.c = !0;
  ...
  x.Xe = function (a) {
    x.Sk() &&
      x.Ok(function () {
        ...
        return Promise.all([
          W.la("res.dat", "arraybuffer").then(function (a) {
            a = new JSZip(a);
            q.ya = new gb(a);
            return Promise.all([
              q.ya.ui,
              x
                .Rd(a.file("images/grass.png").asArrayBuffer())
                .then(function (a) {
                  return (q.Ii = a);
                }),
              x
                .Rd(a.file("images/concrete.png").asArrayBuffer())
                .then(function (a) {
                  return (q.gi = a);
                }),
              x
                .Rd(a.file("images/concrete2.png").asArrayBuffer())
                .then(function (a) {
                  return (q.ei = a);
                }),
              x
                .Rd(a.file("images/typing.png").asArrayBuffer())
                .then(function (a) {
                  return (q.eh = a);
                }),
            ]);
  ...
  x.Kc = function (a) {
    ...
    null != a && (x.Od.appendChild(a), (x.sh = a));
  };
  hb.c = !0;
  hb.prototype = {
    hg: function () {
    ...
    hc: function () {
      this.ic.X();
      var a = window.performance.now();
      (1 == q.P.Df.la() && 28.333333333333336 > a - this.Uc) ||
        ((this.Uc = a),
        this.be++,
        this.Qg(q.P.lc.la()),
    ...
    Qg: function (a) {
      var b = this.T.Ya;
      0 >= a
        ? (b.Pg(!0), (b.Ua.Be = 1), (b.Ua.Pe = 0))
        : (b.Pg(!1), (b.Ua.Pe = 35), (b.Ua.Be = 1 + 0.25 * (a - 1)));
    },
    oj: function () {},
    f: hb,
  };
  ...
  C.cj = function () {
    window.___init___ = function (a, b) {
      "string" == typeof a
        ? (C.Ig = a)
        : a instanceof ArrayBuffer && (C.Hg = a);
      C.sd = b;
      x.Xe(C.lj);
    };
  };
  C.lj = function () {
    null != C.Hg
      ? C.ae(C.Hg)
      : null != C.Ig
      ? (x.Kc(new Q("Loading Replay", "loading...", []).h),
        W.la(C.Ig, "arraybuffer").then(
          function (a) {
            C.ae(a);
          },
          function () {
  ...
  fb.prototype = {
    update: function () {
      ...
      0 >= this.Td &&
        0.05 > this.Ic &&
        (window.clearInterval(this.Ud), (this.Ud = null), (this.Ic = 0));
    ...
    cf: function (a) {
      ...
      null == this.Ud &&
        ((this.Ud = window.setInterval(function () {
          b.update();
        }, 17)),
          ...
          for (a = a.L; n < a.length; ) {
            ...
            if (null != q.w) {
              var r = q.w.a,
                ...
                t = t * t + r * r;
              if (q.fa == p.Y) {
                if (null == d || d.a.x * k < q.w.a.x * k) d = q.w;
                if (null == e || e.a.x * k > q.w.a.x * k) e = q.w;
                if (null == f || t < h) (f = q.w), (h = t);
              } else if (q.fa == p.wa) {
                if (null == m || m.a.x * k < q.w.a.x * k) m = q.w;
                if (null == l || l.a.x * k > q.w.a.x * k) l = q.w;
                if (null == u || t < g) (u = q.w), (g = t);
              }
            }
          }
          null != l &&
            null != e &&
            0 >= b.za &&
            (f.a.x > l.a.x && c.a.x > l.a.x && 20 < c.a.x && this.cf(0.3),
            u.a.x < e.a.x && c.a.x < e.a.x && -20 > c.a.x && this.cf(0.3));
        }
    },
    f: fb,
  };
  ...
  I.prototype = {
    Oi: function (a) {
      ...
      this.Z.Ja = this.I.Ja;
      a = 0;
      for (var b = this.I.s; a < b.length; ) this.Z.s.push(b[a++].dj());
      this.Nf();
    },
    Kf: function (a) {
      if (a.fa == p.va) a.w = null;
      else {
        a.zb = 0;
        var b = a.w;
        null == b && ((b = new P()), (a.w = b), this.Z.s.push(b));
        var c = this.I.Ac;
        b.H = 0;
        b.M = c.M;
        b.N = c.N;
        ...
        0 == d.length
          ? ((b.a.x = a.fa.$d * this.I.gb), (b.a.y = 0))
    ...
    X: function (a) {
      if (0 < this.za) 120 > this.za && this.za--;
      else {
        var b = this.ta.kl;
        null != b && b();
        ...
        if (0 == this.Na) {
          for (a = 0; a < b.length; )
            (c = b[a]), ++a, null != c.w && (c.w.g = 39 | this.xc.Ti);
          b = this.Z.s[0].o;
          0 < b.x * b.x + b.y * b.y && (this.Na = 1);
        } else if (1 == this.Na) {
          this.Cb += 0.016666666666666666;
          for (a = 0; a < b.length; )
            (d = b[a]), ++a, null != d.w && (d.w.g = 39);
          d = p.va;
          b = this.Z.s;
          for (
            a = 0;
            a < c &&
            ((d = a++), (d = this.I.Wh(b[I.vf[d]].a, I.gg[d])), d == p.va);
          ...
          d != p.va
            ? ((this.Na = 2),
              ...
              null != this.ta.Zj && this.ta.Zj(d.Ha))
            : 0 < this.ma &&
              this.Cb >= 60 * this.ma &&
              this.$a != this.Ta &&
              (null != this.ta.Oe && this.ta.Oe(), this.Zg());
        } else if (2 == this.Na)
          this.rb--,
            0 >= this.rb &&
              ((0 < this.Da && (this.$a >= this.Da || this.Ta >= this.Da)) ||
              (0 < this.ma && this.Cb >= 60 * this.ma && this.$a != this.Ta)
                ? this.Zg()
                : (this.Nf(), null != this.ta.Cj && this.ta.Cj()));
        else if (
          3 == this.Na &&
          (this.rb--, 0 >= this.rb && ((b = this.ta), null != b.D))
        ) {
          b.D = null;
          a = 0;
          for (c = b.L; a < c.length; )
            (d = c[a]), ++a, (d.w = null), (d.Sa = 0);
          null != b.gd && b.gd(null);
        }
      }
    },
    ...
    Nf: function () {
      ...
      this.Na = 0;
      for (
        var b = this.I.s, c = this.Z.s, d = 0, e = this.I.bd ? b.length : 1;
        d < e;
      ...
      b = [0, 0, 0];
      for (c = 0; c < a.length; )
        if (((d = a[c]), ++c, this.Kf(d), (e = d.fa), e != p.va)) {
          var f = d.w.a,
            h = this.I,
            m = b[e.Ha],
            l = e == p.Y ? h.gc : h.ac;
    ...
    yb: function () {
      var a = da.Nb,
        b = this.kb;
      this.lb != a &&
        (null == b && (this.kb = b = new I()), (this.lb = a), I.bc(b, this));
      return b;
    },
    f: I,
  };
  ...
  g.$ = function (a) {
    var b = a.G();
    return 255 == b ? ((b = new g()), b.Ak(a), b) : g.fe()[b];
  };
  g.fe = function () {
    if (null == g.Ma) {
      g.Ma = [];
  ...
  g.xd = function (a) {
    ...
    if ("string" == typeof a) return K.parseInt("0x" + K.Lc(a));
  ...
  g.Ri = function (a) {
    var b = { d0: a.vc, d1: a.wc, length: a.Ra >= a.ib ? a.Ra : [a.Ra, a.ib] };
    g.Hd(b, a.H, 0);
  ...
  g.Wi = function (a, b) {
    var c = new ta(),
      ...
      h = a.strength,
      m = a.length;
    if (d >= b.length || 0 > d) throw new r(null);
    if (e >= b.length || 0 > e) throw new r(null);
    c.vc = d;
    c.wc = e;
    null == m
      ? ((d = b[d]),
        ...
        null == d || null == m
          ...
          : ((e = d.a),
            ...
            (d = e.x - m.x),
            (e = e.y - m.y),
            (c.ib = c.Ra = Math.sqrt(d * d + e * e))))
      : m instanceof Array && null == m.oc
      ? ((c.Ra = n.v(m[0], t)), (c.ib = n.v(m[1], t)))
      : (c.ib = c.Ra = n.v(m, t));
  ...
  g.yj = function (a) {
    var b = { normal: [a.ia.x, a.ia.y], dist: a.Aa };
    g.U(b, "bCoef", a.i, 1);
    g.Db(b, "cMask", a.g, 63);
    g.Db(b, "cGroup", a.j, 32);
    return b;
  ...
  g.Aj = function (a) {
    var b = {};
    g.U(b, "bCoef", a.i, 0.5);
    g.U(b, "invMass", a.N, 0.5);
    g.U(b, "damping", a.ka, 0.96);
    g.U(b, "acceleration", a.Mc, 0.1);
    g.U(b, "kickingAcceleration", a.Sc, 0.07);
    g.U(b, "kickingDamping", a.Tc, 0.96);
    g.U(b, "kickStrength", a.Qc, 5);
    g.Db(b, "cGroup", a.j, 0);
    if (0 != a.V.x || 0 != a.V.y) b.gravity = [a.V.x, a.V.y];
    g.U(b, "radius", a.M, 15);
  ...
  g.Yi = function (a) {
    ...
    null != l && (b.Qc = n.v(l, t));
    null != u &&
      ((c = b.V), (d = n.v(u[1], t)), (c.x = n.v(u[0], t)), (c.y = d));
    null != k && (b.j = g.Ab(k));
    null != p && (b.M = n.v(p, t));
    null != a && (b.Rc = n.v(a, t));
    return b;
  ...
  g.ri = function (a, b) {
    ...
    if (a.o.x != b.o.x || a.o.y != b.o.y) c.speed = [a.o.x, a.o.y];
    if (a.V.x != b.V.x || a.V.y != b.V.y) c.gravity = [a.V.x, a.V.y];
  ...
  g.Sf = function (a, b) {
    ...
    null != d && ((c = b.o), (c.x = d[0]), (c.y = d[1]));
    null != e && ((d = b.V), (d.x = e[0]), (d.y = e[1]));
    null != f && (b.M = n.v(f, t));
    null != h && (b.i = n.v(h, t));
    null != m && (b.N = n.v(m, t));
    null != l && (b.ka = n.v(l, t));
  ...
  g.prototype = {
    ...
    ca: function (a) {
      ...
      if (!this.je()) {
        ...
        a.R(this.J.length);
        b = 0;
        for (c = this.J; b < c.length; ) c[b++].ca(a);
        a.R(this.W.length);
        b = 0;
        for (c = this.W; b < c.length; ) c[b++].ca(a);
        a.R(this.pb.length);
        b = 0;
        for (c = this.pb; b < c.length; ) c[b++].ca(a);
        a.R(this.s.length);
        b = 0;
        for (c = this.s; b < c.length; ) c[b++].ca(a);
        a.R(this.Ja.length);
        b = 0;
        for (c = this.Ja; b < c.length; ) c[b++].ca(a);
        a.R(this.gc.length);
        b = 0;
        for (c = this.gc; b < c.length; ) (d = c[b]), ++b, a.l(d.x), a.l(d.y);
        a.R(this.ac.length);
        b = 0;
        for (c = this.ac; b < c.length; ) (d = c[b]), ++b, a.l(d.x), a.l(d.y);
      }
    },
    Ak: function (a) {
      function b() {
      ...
      this.J = [];
      c = a.G();
      for (d = 0; d < c; ) ++d, (e = new z()), e.$(a, this.B), this.J.push(e);
      this.W = [];
      c = a.G();
      for (d = 0; d < c; ) ++d, (e = new D()), e.$(a), this.W.push(e);
      this.pb = [];
      c = a.G();
      for (d = 0; d < c; ) ++d, (e = new Ra()), e.$(a), this.pb.push(e);
      this.s = [];
      c = a.G();
      for (d = 0; d < c; ) ++d, (e = new U()), e.$(a), this.s.push(e);
      this.Ja = [];
      c = a.G();
      for (d = 0; d < c; ) ++d, (e = new ta()), e.$(a), this.Ja.push(e);
      this.gc = b();
      this.ac = b();
      this.Bc();
    },
    Bc: function () {
      for (var a = 0, b = this.J; a < b.length; ) b[a++].Bc();
    },
    je: function () {
      return 255 != this.Zd;
    },
    ...
    yk: function () {
      ...
      b = [];
      e = 0;
      for (f = this.J; e < f.length; ) b.push(g.jk(f[e++], d));
      d = [];
      e = 0;
      for (f = this.W; e < f.length; ) d.push(g.yj(f[e++]));
      for (var e = [], f = 0, h = this.pb; f < h.length; ) e.push(g.Hi(h[f++]));
      for (
        var f = g.Aj(this.Ac), m = new U(), h = [], l = 0, u = this.s;
        l < u.length;
      ...
      m = [];
      l = 0;
      for (u = this.Ja; l < u.length; ) m.push(g.Ri(u[l++]));
    ...
    Rf: function (a) {
      ...
      "disc0" != a &&
        (null != a
          ? ((a = g.Sf(a, this.zd())), (a.j |= 192), this.s.push(a))
          : this.s.push(this.zd()));
    ...
    Wh: function (a, b) {
      for (var c = 0, d = this.pb; c < d.length; ) {
        ...
        var f = e.K,
          ...
          m = b.x - a.x,
          l = b.y - a.y;
        0 < -(f.y - a.y) * m + (f.x - a.x) * l ==
        0 < -(h.y - a.y) * m + (h.x - a.x) * l
          ? (f = !1)
          : ((m = h.x - f.x),
            (h = h.y - f.y),
            (f =
    ...
    Ad: function (a, b, c, d, e, f, h) {
      ...
      for (b = this.B.length; m < b; )
        (l = m++), (this.B[l].g = f), (this.B[l].j = h), (this.B[l].i = 0.1);
      b = this.J.length;
      this.J.push(g);
      this.J.push(p);
      this.J.push(q);
      ...
      for (b = this.J.length; m < b; )
        (l = m++), (this.J[l].g = f), (this.J[l].j = h), (this.J[l].i = 0.1);
      f = new U();
      h = f.a;
      h.x = a;
      h.y = -c;
  ...
  aa.prototype = {
    ca: function (a) {
      ...
      a.ea(this.kc);
      a.R(this.Wa.length);
      for (var b = 0, c = this.Wa; b < c.length; ) a.ea(c[b++]);
    },
    $: function (a) {
      this.qc = a.G();
      this.kc = a.F();
      ...
      this.Wa = [];
      for (var c = 0; c < b; ) ++c, this.Wa.push(a.F());
    },
    f: aa,
  };
  p.c = !0;
  ...
  ca.bc = function (a, b) {
    a.Fb = b.Fb;
    if (null == b.L) a.L = null;
    else {
      null == a.L && (a.L = []);
      for (var c = a.L, d = b.L, e = d.length; c.length > e; ) c.pop();
  ...
  ca.prototype = {
    ...
    qd: function (a, b, c) {
      if (b.fa != c) {
        ...
        this.L.push(b);
        if (null != this.D) {
          null != b.w && (F.remove(this.D.Z.s, b.w), (b.w = null));
          this.D.Kf(b);
          for (var d = 0, e = !1; !e; ) {
            ++d;
    ...
    ca: function (a) {
      ...
      a.R(this.L.length);
      for (var b = 0, c = this.L; b < c.length; ) c[b++].Yk(a);
      this.Fa[1].ca(a);
      this.Fa[2].ca(a);
    },
    $: function (a) {
      ...
      var b = 0 != a.G();
      this.D = null;
      b && ((this.D = new I()), this.D.$(a, this));
      for (
        var b = null == this.D ? null : this.D.Z.s, c = a.G(), d = this.L;
        d.length > c;
    ...
    Ei: function () {
      var a = 0,
        b = H.ff();
      this.ca(b);
      for (b = b.xk(); 4 <= b.A.byteLength - b.a; ) a ^= b.F();
      return a;
    },
    di: function (a) {
    ...
    yb: function () {
      var a = da.Nb,
        b = this.kb;
      this.lb != a &&
        (null == b && (this.kb = b = new ca()), (this.lb = a), ca.bc(b, this));
      return b;
    },
    f: ca,
  };
  ...
  T.prototype = {
    ...
    Rk: function () {
      var a = da.Nb,
        b = this.wh;
      this.Nb != a &&
        (null == b && (this.wh = b = new T()), (this.Nb = a), T.Mk(b, this));
      return b;
    },
    f: T,
  };
  ...
  Qa.prototype = y(k.prototype, {
    apply: function (a) {
      var b = a.sa(this.S);
      null != b && this.uh != b.nc && ((b.nc = this.uh), A.u(a.pg, b));
    },
    ga: function (a) {
      this.uh = 0 != a.G();
    },
  ...
  Pa.prototype = y(k.prototype, {
    ...
    ga: function (a) {
      this.kd = a.Ag();
      if (1e3 < this.kd.length) throw new r("message too long");
      this.color = a.F();
      this.style = a.G();
      this.cl = a.G();
    },
  ...
  Oa.prototype = y(k.prototype, {
    apply: function (a) {
      if (a.Va(this.S, 1)) {
        for (
          var b = a.sa(this.S), c = a.L, d = [], e = 0, f = 0, h = 0;
          h < c.length;
        ...
        0 != c &&
          (f == e
            ? 2 > c || (a.qd(b, d[0], p.Y), a.qd(b, d[1], p.wa))
            : a.qd(b, d[0], f > e ? p.Y : p.wa));
      }
    },
    ga: function () {},
    f: Oa,
    ...
    apply: function (a) {
      if (a.Va(this.S, 4)) {
        ...
        null != c &&
          0 != c.aa &&
          c.cb != this.th &&
          ((c.cb = this.th), null != a.ye && a.ye(b, c));
      }
    },
    ga: function (a) {
      this.af = a.F();
  ...
  Ja.prototype = y(k.prototype, {
    apply: function (a) {
      if (a.Va(this.S, 8)) {
        var b = a.sa(this.S);
        null == a.D && ((a.I = this.ld), null != a.Ke && a.Ke(b, this.ld));
      }
    },
    ga: function (a) {
  ...
  Da.prototype = y(k.prototype, {
    ...
    ga: function (a) {
      this.kd = a.Ag();
      if (140 < this.kd.length) throw new r("message too long");
    },
    f: Da,
  });
  Ca.c = !0;
  ...
  za.prototype = y(k.prototype, {
    ...
    ga: function (a) {
      ...
      var b = a.G();
      this.vh = [];
      for (var c = 0; c < b; ) ++c, this.vh.push(a.F());
    },
    f: za,
  });
  ya.c = !0;
      ...
      if (0 == this.S) {
        ...
        if (null != b) {
          if (this.Tk) {
            ...
            if (null == a) return;
            a = a.w;
          } else a = b.Z.s[this.Sd];
          null != a &&
            (null != this.ua[0] && (a.a.x = this.ua[0]),
  ...
  ua.prototype = y(k.prototype, {
    ...
    ga: function (a) {
      this.$e = [];
      for (var b = a.Wb(), c = 0; c < b; ) ++c, this.$e.push(a.Wb());
    },
    f: ua,
  });
  P.c = !0;
  ...
  P.prototype = {
    ...
    yb: function () {
      var a = da.Nb,
        b = this.kb;
      this.lb != a &&
        (null == b && (this.kb = b = new P()), (this.lb = a), P.bc(b, this));
      return b;
    },
    f: P,
  };
    ...
    X: function (a) {
      ...
      if (null != b && null != a) {
        ...
        if (!(0 >= f)) {
          ...
          d != d && (d = 0.5);
          var h, m;
          if (this.Ra >= this.ib) (h = this.Ra), (m = 0);
          else if (f <= this.Ra) (h = this.Ra), (m = 1);
          else if (f >= this.ib) (h = this.ib), (m = -1);
          else return;
          f = h - f;
          if (0 == 0 * this.Ec)
            (d = this.Ec * f * 0.5),
  ...
  ba.pc = [ia];
  ba.bc = function (a, b) {
    if (null == b.s) a.s = null;
    else {
      null == a.s && (a.s = []);
      for (var c = a.s, d = b.s, e = d.length; c.length > e; ) c.pop();
      for (var e = 0, f = d.length; e < f; ) {
        var h = e++;
        c[h] = d[h].yb();
      }
    ...
    X: function (a) {
      ...
      for (b = this.s.length; a < b; ) {
        ...
        for (e = this.s.length; d < e; )
          (f = this.s[d++]), 0 != (f.g & c.j) && 0 != (f.j & c.g) && c.ai(f);
        if (0 != c.N) {
          d = 0;
          for (e = this.W; d < e.length; )
            if (((f = e[d]), ++d, 0 != (f.g & c.j) && 0 != (f.j & c.g))) {
              var h = f.ia,
                g = c.a,
          ...
          for (e = this.J; d < e.length; )
            (f = e[d]), ++d, 0 != (f.g & c.j) && 0 != (f.j & c.g) && c.bi(f);
          d = 0;
      ...
      for (a = 0; 2 > a; )
        for (++a, b = 0, c = this.Ja; b < c.length; ) c[b++].X(this.s);
    },
    yb: function () {
      var a = da.Nb,
        b = this.kb;
      this.lb != a &&
        (null == b && (this.kb = b = new ba()), (this.lb = a), ba.bc(b, this));
      return b;
    },
    f: ba,
  };
  ...
  z.prototype = {
    ca: function (a) {
      ...
      a.R(this.K.dc);
      a.R(this.O.dc);
      0 != this.xb && ((b = 1), a.l(this.xb));
      this.La != 1 / 0 && ((b |= 2), a.l(this.La));
      0 != this.H && ((b |= 4), a.ea(this.H));
      this.Ca && (b |= 8);
      a.A.setUint8(c, b);
      a.l(this.i);
      a.ea(this.g);
  ...
  E.prototype = {
    ...
    Ek: function () {
      if (null != this.ha.parentElement) {
        ...
        if (this.ha.width != c || this.ha.height != a)
          (this.ha.width = c), (this.ha.height = a);
      }
    },
    hc: function (a, b) {
      ...
      if (null != a.D) {
        var c = a.D,
          ...
          g =
            0 != this.xg
              ? this.ha.height / this.xg
              : this.Be * window.devicePixelRatio * this.He,
          k = this.Pe * this.He,
          n = c.I.Wc,
          p = this.ha.width / g;
        0 < n && p > n && ((p = n), (g = this.ha.width / n));
        ...
        for (var q = 0, t = a.L; q < t.length; ) {
          ...
          if (null != r.w) {
            ...
            null == v && ((v = new Z()), this.Vb.set(r.aa, v));
            v.X(r, a);
            this.Md.set(r.w, v);
          }
        }
        ...
        g = e.s;
        k = 0;
        for (q = e.Ja; k < q.length; ) this.Pj(q[k++], g);
        this.Oj(a, p, n);
        this.Qj(a, f);
        null != h && this.Sj(h.a);
        this.b.lineWidth = 2;
        ...
        for (e = e.s; f < e.length; )
          (h = e[f]), ++f, null == this.Md.get(h) && this.Fg(h, null);
        this.b.lineWidth = 3;
        this.b.resetTransform();
        this.b.translate(this.ha.width / 2, this.ha.height / 2);
        this.Rj(c);
        0 >= c.za && (this.cc.X(d), this.cc.hc(this.b));
        this.Md.clear();
        this.Nj(a);
      }
    },
    Nj: function (a) {
      var b = new Set(),
        c = 0;
      for (a = a.L; c < a.length; ) b.add(a[c++].aa);
      c = this.Vb.keys();
      for (a = c.next(); !a.done; ) {
        var d = a.value;
        a = c.next();
        if (!b.has(d)) this.Vb["delete"](d);
      }
    },
    Ck: function (a, b, c, d, e) {
      var f, h;
      if (null != b && 1 == a.I.Oc) (h = b.a), (f = h.x), (h = h.y);
      else if (((h = a.Z.s[0].a), (f = h.x), (h = h.y), null != b)) {
        var g = b.a;
        f = 0.5 * (f + g.x);
        h = 0.5 * (h + g.y);
        var k = 0.5 * c,
    ...
    ii: function (a, b, c) {
      a > 2 * c.gb
        ? (this.Ba.x = 0)
        : this.Ba.x + 0.5 * a > c.gb
        ? (this.Ba.x = c.gb - 0.5 * a)
        : this.Ba.x - 0.5 * a < -c.gb && (this.Ba.x = -c.gb + 0.5 * a);
      b > 2 * c.ob
        ? (this.Ba.y = 0)
        : this.Ba.y + 0.5 * b > c.ob
        ? (this.Ba.y = c.ob - 0.5 * b)
        : this.Ba.y - 0.5 * b < -c.ob && (this.Ba.y = -c.ob + 0.5 * b);
    },
    Sj: function (a) {
      this.b.beginPath();
    ...
    Rj: function (a) {
      ...
      b &&
        (120 != a.za &&
          ...
          this.b.fillRect(0.5 * -a, 100, a, 20)),
        this.cc.wj.Wj(this.b));
    },
    lk: function (a) {
      this.Lf != a &&
        ((this.ha.style.filter = a ? "grayscale(70%)" : ""), (this.Lf = a));
    },
    ...
    Vj: function (a) {
      ...
      if (1 == a.$b)
        ...
        e = function (c, e, g) {
          ...
          0 != e && (b.b.moveTo(e, -d), b.b.lineTo(e, d));
          b.b.stroke();
        };
        e("#85ACF3", c, !1);
        e("#E18977", -c, !0);
    ...
    Qj: function (a, b) {
      for (var c = q.P.If.la(), d = 0, e = a.L; d < e.length; ) {
        ...
        if (null != h) {
          var h = h.a,
            g = this.Vb.get(f.aa);
          c && g.wd && this.b.drawImage(q.eh, h.x - 0.5 * q.eh.width, h.y - 35);
    ...
    Fg: function (a, b) {
      this.b.beginPath();
      null == b
        ? ((this.b.fillStyle = E.nb(a.H)), (this.b.strokeStyle = "black"))
        : ((this.b.fillStyle = b.kf), (this.b.strokeStyle = b.pi));
      this.b.beginPath();
      ...
      if (null != b) {
        ...
        this.b.fill();
        this.b.restore();
      } else -1 != (a.H | 0) && this.b.fill();
      this.b.stroke();
    },
    Uj: function (a) {
      if (null != a) {
        var b = 0;
        for (a = a.J; b < a.length; ) this.Tj(a[b++]);
      }
    },
    Pj: function (a, b) {
      if (!(0 > a.H)) {
    ...
    Tj: function (a) {
      if (a.Ca) {
        ...
        var b = a.K.a,
          c = a.O.a;
        if (0 != 0 * a.La) this.b.moveTo(b.x, b.y), this.b.lineTo(c.x, c.y);
        else {
          a = a.uc;
          var d = b.x - a.x,
            b = b.y - a.y;
    ...
    Oj: function (a, b, c) {
      ...
      if (null != d)
        for (
          d = d.Z.s[0], this.Af(d.a, d.H, b, c), d = 0, a = a.L;
          d < a.length;
    ...
    Af: function (a, b, c, d) {
      ...
      a = a.y - d;
      900 < f * f + a * a &&
        ((this.b.fillStyle = "rgba(0,0,0,0.5)"),
  ...
  J.prototype = {
    zi: function () {
      return 2.31 + 0.1155 * (this.Vc.length - 1);
    },
    hc: function (a, b) {
      var c = b / 2.31,
        d = 0;
      ...
      for (var e = 0, f = this.Vc; e < f.length; ) {
        ...
        a.drawImage(
          h,
          k - 0.5 * h.width,
          35 * -(this.Vc.length - 1) + 70 * d - 0.5 * h.height
        );
        a.globalAlpha = 1;
        ++d;
      }
    ...
    Wj: function (a) {
      ...
      for (var c = 0, d = this.Vc; c < d.length; ) {
        ...
        a.drawImage(
          e,
          0.5 * -e.width,
          35 * -(this.Vc.length - 1) + 70 * b - 0.5 * e.height
        );
        ++b;
      }
      a.imageSmoothingEnabled = !1;
  ...
  eb.prototype = {
    ...
    X: function (a) {
      0 < this.qb.length &&
        ((this.ub += a),
        this.ub > this.qb[0].zi() && ((this.ub = 0), this.qb.shift()));
    },
    hc: function (a) {
  ...
  Z.c = !0;
  Z.Xh = function (a, b) {
    if (a.qc != b.qc || a.kc != b.kc) return !1;
    var c = a.Wa,
      d = b.Wa;
  ...
  Z.prototype = {
    ...
    Dk: function () {
      ...
      a.fillStyle = "white";
      160 < a.measureText(this.C).width
  ...
  Y.prototype = {
    ...
    Vf: function (a) {
      var b = this.Bb.clientHeight,
        b =
          this.Bb.scrollTop + b - this.Bb.scrollHeight >= 0.5 * -b ||
          !Y.Pi(this.Bb);
  ...
  sa.prototype = {
    ...
    Vh: function (a, b) {
      ...
      if (null != c) {
        var d = c[0],
          e = new RegExp(
            F.substr(d, 1, null).split("").map(sa.xi).join(".*?"),
            "i"
          );
        this.Mf = "#" == d.charAt(0);
        this.De = c.index;
    ...
    zf: function (a) {
      ...
      this.qj(
        F.substr(this.Gg, 0, this.De) +
          a +
          " " +
          F.substr(this.Gg, this.De + this.Yj, null),
        this.De + a.length + 1
      );
    },
    Re: function (a) {
    ...
    pf: function (a) {
      if (null != this.Qb) {
        ...
        a = this.Qb[this.sb];
        b != this.sb &&
          (a.Kb.classList.toggle("selected", !0),
        ...
        b < this.Xa.scrollTop
          ? (this.Xa.scrollTop = b)
          : a > c && (this.Xa.scrollTop = a - this.Xa.clientHeight);
      }
    },
    ti: function () {
      null != this.Qb && (this.zf(this.Qb[this.sb].item), this.ge());
    },
    f: sa,
  };
  ra.c = !0;
  ...
  db.prototype = {
    ...
    nk: function (a) {
      a != this.xf &&
        ((this.vj.className = a ? "overtime on" : "overtime"), (this.xf = a));
    },
    rk: function (a) {
      a != this.yf &&
        ((this.h.className = a
  ...
  fa.prototype = {
    X: function (a) {
      ...
      this.Dc
        ? this.cd.X(a.bb, a.bb.sa(a.qe))
        : ((a = a.Gf()), this.Ya.X(a), q.ya.rf.gl(a));
    },
    ed: function (a) {
      this.Dc != a &&
        ((this.Dc = a)
          ? (this.de.appendChild(this.cd.h), this.Ya.h.remove())
          : (this.de.appendChild(this.Ya.h), this.cd.h.remove()));
    },
    Hb: function (a, b) {
      v.bf(this.Yc);
      fa.zl = a;
      null != a
        ? ((this.Yc.style.display = "flex"),
          this.Yc.appendChild(a),
          (this.wg = b))
        : ((this.Yc.style.display = "none"), (this.wg = null));
    },
    f: fa,
  };
  qa.c = !0;
  ...
  na.prototype = {
    X: function (a, b) {
      this.h.draggable = b;
      this.jb != a.jb &&
        ((this.jb = a.jb), (this.xe.textContent = "" + this.jb));
  ...
  S.prototype = {
    ...
    X: function () {
      ...
      !this.vd || 0 < this.Ee.jc || ((this.vd = !1), this.rj());
    },
    f: S,
  };
  ma.c = !0;
  ...
  la.prototype = {
    ...
    X: function (a, b) {
      this.Xj != a.Fb && ((this.Xj = a.Fb), (this.Fb.textContent = a.Fb));
      var c = null == b ? !1 : b.cb;
      this.wf != c &&
        ((this.h.className = "room-view" + (c ? " admin" : "")), (this.wf = c));
      var d = !c || null != a.D;
      this.hd.disabled = d;
      this.dd.disabled = d;
      this.Xg.disabled = d;
      ...
      d && ((c = 120 == a.D.za), this.lg != c && this.hf(c));
    },
    gf: function (a) {
      this.me = a;
      this.Tf.innerHTML = this.me
    ...
    hf: function (a) {
      this.lg = a;
      this.ve.innerHTML =
        "<i class='icon-pause'></i>" + (this.lg ? "Resume (P)" : "Pause (P)");
    },
    f: la,
  };
  R.c = !0;
  ...
  r.c = !0;
  r.ba = Error;
  r.prototype = y(Error.prototype, { f: r });
  n.c = !0;
  n.Pk = function (a) {
    if (a instanceof Array && null == a.oc) return Array;
    var b = a.f;
    if (null != b) return b;
    a = n.ef(a);
      ...
      default:
        if (null != a)
          if ("function" == typeof b) {
            if (a instanceof b || n.Xd(n.Pk(a), b)) return !0;
          } else {
            if ("object" == typeof b && n.Ih(b) && a instanceof b) return !0;
          }
        else return !1;
        return (b == xb && null != a.c) || (b == yb && null != a.Gh)
          ? !0
          : $hxEnums[a.oc] == b;
    }
  };
  n.v = function (a, b) {
    if (n.Hh(a, b)) return a;
  ...
  k.qh = new Map();
  k.Ue = 0;
  Ua.na = k.oa({ ra: !1, qa: !1 });
  da.Nb = 0;
  q.Nh = "https://www.haxball.com/rs/";
  q.P = new kb();
  I.gg = (function () {
    for (var a = [], b = 0; 256 > b; ) ++b, a.push(new B(0, 0));
    return a;
  })(this);
  I.vf = (function () {
  ...
  g.vk = H.ff(1024);
  Qa.na = k.oa({ ra: !1, qa: !1 });
  Pa.na = k.oa({ ra: !1, qa: !1, xh: { kh: 10, Ah: 900 } });
  Oa.na = k.oa({ ra: !1, qa: !1 });
  Na.na = k.oa({ ra: !1, qa: !1 });
  Ma.na = k.oa({ ra: !1, qa: !1 });
  La.na = k.oa({ ra: !1, qa: !1 });
  Ka.na = k.oa({ ra: !1, qa: !1 });
  Ja.na = k.oa({ ra: !1, qa: !1, xh: { kh: 10, Ah: 2e3 } });
  Ia.na = k.oa({ ra: !1, qa: !1 });
  Ha.na = k.oa({ ra: !1, qa: !1 });
  Ga.na = k.oa({ ra: !1, qa: !1 });
  Fa.na = k.oa({ ra: !1, qa: !1 });
  Ea.na = k.oa({});
  Da.na = k.oa({ ra: !1, qa: !1, xh: { kh: 10, Ah: 900 } });
  Ca.na = k.oa({});
  Ba.na = k.oa({ ra: !1, qa: !1 });
  Aa.na = k.oa({ ra: !1, qa: !1 });
  za.na = k.oa({ ra: !1, qa: !1 });
  ya.na = k.oa({ ra: !1, qa: !1 });
  xa.na = k.oa({ ra: !1, qa: !1 });
  wa.na = k.oa({ ra: !1, qa: !1 });
  va.na = k.oa({ ra: !1, qa: !1 });
  ua.na = k.oa({ ra: !1, qa: !1 });
  z.Eh = 0.17435839227423353;
  z.Dh = 5.934119456780721;
  J.Bh = new $a([0, 0, 2, 1, 0, 0.35, 1, 0, 1, 0, 0.7, 1, 0, 0, 0, 1]);
  J.Ch = new $a([0, -1, 3, 0, 0, 0.35, 0, 0, 0, 0, 0.65, 0, 0, 1, 3, 1]);
  Y.da =
  ...
  ma.da =
    "<div class='simple-dialog-view'><div class='dialog'><h1>Select replay file</h1><div class='file-btn'><label for='replayerfile'>Load</label><input id='replayerfile' type='file' accept='.hbr2' data-hook='file'/></div></div></div>";
  la.da =
